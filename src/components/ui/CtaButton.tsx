...
const CtaButton: FC<CtaButtonProps> = ({ 
  ...
  const variantClasses = {
    primary: "bg-accent-700 text-white hover:bg-accent-800 focus:ring-accent-700 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5",
    ...
    outline: "border-2 border-accent-500 text-accent-700 hover:bg-accent-700 hover:text-white focus:ring-accent-700"
  };
