...
const Home: FC = () => {
  ...
  const seoTitle = t(
    'home:seo.title',
    'MB Fret Services - Transport International entre Europe, Asie et Afrique'
  );
  const seoDescription = t(
    'home:seo.description',
    "MB Fret Services : Votre spécialiste du transport international. Fret maritime et aérien vers l'Afrique, l'Asie et l'Europe. Dédouanement et logistique intégrée."
  );
    ...
    <div className="pt-16">
      <SEO
        ...
        jsonLd={{
          ...
          '@type': 'WebPage',
          name: `${t('navbar:home', 'Accueil')} - MB Fret Services`,
          url: SITE_URL + '/',
          inLanguage: langTag,
        }}
      />
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-br from-primary-900 to-primary-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center animate-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            {t('home:final_cta_title', 'Prêt à expédier vos marchandises ?')}
          </h2>
          <p className="text-xl text-gray-200 mb-8 leading-relaxed">
            {t(
              'home:final_cta_text',
              "Obtenez un devis personnalisé en moins de 24h. Notre équipe d'experts vous accompagne à chaque étape de votre projet logistique."
            )}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              {t('home:whatsapp', 'Nous contacter via WhatsApp')}
            </a>
          </div>
        </div>
      </section>
