...
const SLUGS = {
  ...
  pt: {
    ...
    services_freight_france_rdc: 'servicos/frete-maritimo/franca-rdc',
    ...
    services_freight_france_rdc_fcl_lcl: 'servicos/frete-maritimo/franca-rdc/fcl-lcl',
    services_freight_france_rdc_customs: 'servicos/frete-maritimo/franca-rdc/despacho-aduaneiro',
    services_freight_france_rdc_checklist: 'servicos/frete-maritimo/franca-rdc/checklist',
